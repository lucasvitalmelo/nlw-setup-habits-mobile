  ...
  async function handleCreateNewHabit() {
    try {
      if (!title.trim() || weekDays.length === 0) {
        Alert.alert('Novo Hábito', 'Informe o nome do hábitoe escolha a periocidade.')
      }
  ...
  return (
    <View className="flex-1 bg-background px-8 pt-16">
      ...
      >
        ...
        <TouchableOpacity
          className="w-full h-14 rounded-md bg-green-600 flex-row items-center justify-center mt-6 "
          activeOpacity={0.7}
